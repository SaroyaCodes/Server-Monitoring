...
namespace IpHlpApidotnet
{
	public class IPHelper
	{
		...
		public UserInterface.MIB_TCPTABLE TcpConnexion;
        public UserInterface.MIB_TCPSTATS TcpStats;
        public UserInterface.MIB_EXTCPTABLE TcpExConnexions;
		

		/*
		 * Udp Struct
		 * */
        public UserInterface.MIB_UDPSTATS UdpStats;
        public UserInterface.MIB_UDPTABLE UdpConnexion;
        public UserInterface.MIB_EXUDPTABLE UdpExConnexion;
		...
		public void GetTcpConnexions()
		{
            ...
            TcpConnexion.table[i].procID = (int)Marshal.ReadIntPtr(current);
            // Store and get the process name in the struct
            TcpExConnexions.table[i].ProcessName = this.get_process_name(TcpExConnexions.table[i].dwProcessId);
            current = (IntPtr)((int)current + 4);
            }
